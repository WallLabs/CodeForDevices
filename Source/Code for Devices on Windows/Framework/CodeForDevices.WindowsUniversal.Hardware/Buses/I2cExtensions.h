...
#include "CodeForDevices.WindowsUniversal.Hardware.Buses.I2cExtensions.g.h"
...
#pragma region Read
        ...
        /// <param name="writeData">Data to write.</param>
        /// <returns>Read data byte.</returns>
        static uint8_t WriteReadByte(Windows::Devices::I2c::I2cDevice const& device, Windows::Foundation::Collections::IVectorView<uint8_t> const& writeData);
        ...
        /// <param name="size">Amount of data to read.</param>
        /// <returns>Read data bytes.</returns>
        static Windows::Foundation::Collections::IVector<uint8_t> WriteReadBytes(Windows::Devices::I2c::I2cDevice const& device, Windows::Foundation::Collections::IVectorView<uint8_t> const& writeData, uint32_t size);
        ...
        /// <param name="mask">Index of the bit to read, zero based.</param>
        /// <returns>True when the result was positive (any bits in the mask were set).</returns>
        static bool WriteReadBit(Windows::Devices::I2c::I2cDevice const& device, Windows::Foundation::Collections::IVectorView<uint8_t> const& writeData, uint8_t mask);
...
#pragma region Write
        ...
        /// <param name="device">Device to use.</param>
        /// <param name="data">Data to write.</param>
        static void WriteBytes(Windows::Devices::I2c::I2cDevice const& device, Windows::Foundation::Collections::IVectorView<uint8_t> const& data);
        ...
        /// <param name="data1">First part of data to write.</param>
        /// <param name="data2">Second part of data to write.</param>
        static void WriteJoinByte(Windows::Devices::I2c::I2cDevice const& device, Windows::Foundation::Collections::IVectorView<uint8_t> const& data1, uint8_t data2);
        ...
        /// <param name="data1">First part of data to write.</param>
        /// <param name="data2">Second part of data to write.</param>
        static void WriteJoinBytes(Windows::Devices::I2c::I2cDevice const& device, uint8_t data1, Windows::Foundation::Collections::IVectorView<uint8_t> const& data2);
        ...
        /// <param name="data1">First part of data to write.</param>
        /// <param name="data2">Second part of data to write.</param>
        static void WriteJoinBytes(Windows::Devices::I2c::I2cDevice const& device, Windows::Foundation::Collections::IVectorView<uint8_t> const& data1, Windows::Foundation::Collections::IVectorView<uint8_t> const& data2);
